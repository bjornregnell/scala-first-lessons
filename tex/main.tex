...
\begin{Slide}{Experiences with Scala first -- Benefits}
  ...
  \begin{enumerate}
  \item Scala is easy for beginners and interesting for non-beginners %(depending how you teach...)
  ...
  \begin{itemize}
    ...
    \item Scala has a simple-to-learn and powerful standard library
  \end{itemize}
  ...
  \item Scala is exciting to students \& teachers: a modern language -- you can grow 
