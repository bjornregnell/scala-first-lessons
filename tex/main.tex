...
\begin{Slide}{The Java first situation (2015)}
  I took over as course head in 2015 and ran it as usual with Java first, while in parallell heading the development of the Scala first course material as an open source community project with colleagues and senior students.
  ...
  \begin{minipage}[t]{0.45\textwidth}
      ...
      \begin{itemize}
        ...
        \begin{tikzpicture}[scale=0.3, every node/.style={scale=0.8}]
          \pie [color={green!20, green!50, green, red!40} ]  {8/3, 28/4, 48/5, 16/Fail}
        \end{tikzpicture}
...
\begin{itemize}
  ...
  \item Dynamic typing means less help in finding bugs; lack of motivation when stuck
...
\begin{minipage}{0.3\textwidth}
  \includegraphics[height=0.6\textheight]{Pictures/marton}\\
  Marton \& Tsui (2004)
\end{minipage}%
...
\begin{Slide}{Pedagical ideas behind course design}
