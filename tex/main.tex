...
\begin{Slide}{Progression of main themes}
  \begin{minipage}{0.54\textwidth}
    ...
    \begin{tabular}{|l|l|l|l|}
      ...
      W07 & Sequences       &  shuffle    & \\ \hline 
          & Diagnostic test & --          & \\ \hline
      W08 & Matrices        & life        & IntelliJ (opt.)\\
      W09 & Sets, Maps      & words       & \\
  ...
  \end{minipage}%
    \begin{minipage}{0.32\textwidth}
      ...
      \end{itemize}
    \end{minipage}%
    \tikz[overlay]{\node [text width=2.1cm, align=left] at (1,0.5) {\includegraphics[width=1.0\textwidth]{Pictures/compendium}};} 
  \end{Slide}
...
\begin{itemize}
  \item Dynamic typing means less help in finding bugs -> no dialog with the compiler, less conceptual learning
  ...
  \item Refactoring is more risky and hence discouraging
